...
const srcPath = {
  ...
  html: srcBase + "/**/*.html",
  img: srcBaseAssets + "/img/**/*.{png,jpg,jpeg,svg}",
 ...
 */
exports.default = gulp.series(clean, gulp.parallel(html, cssSass, js, image), gulp.parallel(watchFiles, browserSyncFunc));
